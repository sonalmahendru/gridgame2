...
if(isset($_POST['imageData'])){
    ...
    if(file_put_contents("user-results/".$imageName.".png",base64_decode($imageData))){
        $shareUrl = "https://www.facebook.com/sharer/sharer.php?app_id=826539421486313&display=page&u=https://".$_SERVER['HTTP_HOST']."//graph/".$imageName;
...
<head>
    ...
    <meta property="og:title" content="Capture your image" />
    <meta property="og:description" content="Capture Your funny images and share to facebook" />
    ...
    <script>
        function switchpage(){
            window.location.replace("<?php print('https://'.$_SERVER['HTTP_HOST'].'/click.html')?>");
        }
    </script>
</head>
